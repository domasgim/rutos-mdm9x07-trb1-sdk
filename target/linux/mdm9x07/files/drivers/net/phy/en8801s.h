...
/* NAMING DECLARATIONS
 */
#define EN8801S_DRIVER_VERSION  "1.2.1_Generic"
#define EN8801S_PBUS_DEFAULT_ADDR 0x1e
#define EN8801S_PHY_DEFAULT_ADDR 0x1d
#define EN8801S_MDIO_PHY_ID     0x0       /* Range PHY_ADDRESS_RANGE .. 0x1e */
...
#define EN8801S_PHY_ID          \
			(unsigned long)((EN8801S_PHY_ID1 << 16) |\
							 EN8801S_PHY_ID2)
...
enum {
	EN8801S_PORT_LED_OFF = 0,
	EN8801S_PORT_LED_ON = 1,
	EN8801S_PORT_LED_STATUS = 2
};
