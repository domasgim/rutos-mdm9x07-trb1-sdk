...
#define EMAC_QSERDES_COM_PLL_VCOTAIL_EN		0x0004
...
#define EMAC_QSERDES_COM_BGTC			0x0058
#define EMAC_QSERDES_COM_DEC_START1		0x0064
#define EMAC_QSERDES_COM_RES_TRIM_SEARCH	0x0088
...
// 		if (readl_relaxed(phy->base + EMAC_QSERDES_COM_RESET_SM) & READY)
// 			break;
