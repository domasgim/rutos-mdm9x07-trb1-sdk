...
1. **Copy Package Files**
   ...
   ```sh
   cp -r "ipk-example" "TRB1_R_GPL_00.07.23.3/package/base/example_package"
   ```
...
3. **Build the Package**
   ...
   > `TRB1_R_GPL_00.07.23.3/bin/packages/mdm9x07/base`
...
1. **Copy Package to Device**
   ...
   ```sh
   scp "TRB1_R_GPL_00.07.23.3/bin/packages/mdm9x07/base/example_package_1.0-1_mdm9x07.ipk" \
...
2. **Install Package**
   ...
   ```sh
   opkg install /tmp/example_package_1.0-1_mdm9x07.ipk
   ```
...
1. **Modify Package Configuration**
   ...
   Edit `TRB1_R_GPL_00.07.23.3/ipk_packages.json`:
...
4. **Compile Package Manager Packages**
   ...
   > `TRB1_R_GPL_00.07.23.3/bin/packages/<arch_name>/zipped_packages`
