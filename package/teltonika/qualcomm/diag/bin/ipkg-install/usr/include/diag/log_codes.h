...
Copyright (c) 1991-2023 Qualcomm Technologies, Inc.
All Rights Reserved.
...
/* VcTcxo manager automatic frequency control log */
...
/*UWB log codes*/
#define LOG_UWB_UCI_TX_CTRL_C                                 ((0xE28) + LOG_1X_BASE_C)
#define LOG_UWB_UCI_RX_CTRL_C                                 ((0xE29) + LOG_1X_BASE_C)
#define LOG_UWB_UCI_RX_NTF_C                                  ((0xE2A) + LOG_1X_BASE_C)
#define LOG_UWB_UCI_TX_DATA_C                                 ((0xE2B) + LOG_1X_BASE_C)
#define LOG_UWB_UCI_RX_DATA_C                                 ((0xE2C) + LOG_1X_BASE_C)
#define LOG_UWB_UCI_TX_LOG_C                                  ((0xE2D) + LOG_1X_BASE_C)

/*PERI log codes*/
#define LOG_PERI_HCI_CMD_C                                    ((0xE2E) + LOG_1X_BASE_C)
#define LOG_PERI_HCI_EV_C                                     ((0xE2F) + LOG_1X_BASE_C)
#define LOG_PERI_HCI_TX_LOG_C                                 ((0xE30) + LOG_1X_BASE_C)

#define LOG_ETH_STATS_C                                       ((0xE4C) + LOG_1X_BASE_C)
#define LOG_ETH_CONFIG_C                                      ((0xE51) + LOG_1X_BASE_C)
/* Log code for GNSS Client API Ephemeris Report */
#define LOG_GNSS_CLIENT_API_EPH_REPORT_C                      ((0xE58) + LOG_1X_BASE_C)
#define LOG_LOCATION_IDL_SERVICE_REPORT_C                     ((0xE6A) + LOG_1X_BASE_C)
#define LOG_LOCATION_IDL_CLIENT_REPORT_C                      ((0xE6B) + LOG_1X_BASE_C)

/* The last defined DMSS log code */
#define LOG_1X_LAST_C                                         ((0xE6B) + LOG_1X_BASE_C)
