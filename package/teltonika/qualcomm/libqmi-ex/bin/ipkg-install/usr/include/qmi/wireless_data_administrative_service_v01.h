...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/wda/api/wireless_data_administrative_service_v01.h#20 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Mon Nov  7 2022 (Spin 0)
...
#define WDA_V01_IDL_MINOR_VERS 0x21
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define WDA_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define WDA_V01_MAX_MESSAGE_ID 0x0033
/**
    @}
  */
...
typedef enum {
  ...
  WDA_LINK_LAYER_ETHERNET_PDU_MODE_V01 = 0x03, /**<  Ethernet pdu 3gpp spec  */
...
/** @addtogroup wda_qmi_enums
  ...
  */
typedef enum {
  WDA_ETH_HW_CONFIG_ENUM_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  WDA_ETH_HW_NONE_V01 = 0x00, /**<  Ethernet Setting HW Default \n                          */
  WDA_ETH_HW_VLAN_IP_V01 = 0x01, /**<  Ethernet HW VLAN+IP supported \n  */
  WDA_ETH_HW_NON_VLAN_IP_V01 = 0x02, /**<  Ethernet HW NON_VLAN+IP supported   */
  WDA_ETH_HW_CONFIG_ENUM_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}wda_eth_hw_config_enum_v01;
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   EtherType or length.
       ...
       All other values are processed as EtherType as defined by IEEE 802.3.
  */
...
typedef struct {
  ...
  uint8_t qos_format;
  /**<   Indicates whether the client uses the Quality of Service (QOS) data format. Values:\n
  ...
  */
  ...
  /**<   Link protocol used by the client:\n
      ...
      - WDA_LINK_LAYER_ETHERNET_PDU_MODE (0x03) --  Ethernet pdu 3gpp spec
 */
 ...
 */
  ...
  */
  ...
  /**<   \n Peripheral endpoint on which the data format is set.
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Ignore IP ID Mismatch */
  uint8_t ignore_ip_id_mismatch_valid;  /**< Must be set to true if ignore_ip_id_mismatch is being passed */
  uint8_t ignore_ip_id_mismatch;
  /**<   Specifies the handling of IP ID mismatch during coalescing. Values:\n
       - 0 -- Flush on IP ID mismatch (default)\n
       - 1 -- Ignore IP ID mismatch, and continue coalescing
  */

  /* Optional */
  /*  Headroom Capability */
  uint8_t head_room_len_valid;  /**< Must be set to true if head_room_len is being passed */
  uint8_t head_room_len;
  /**<   Indicates whether end_point wants head_room to be allocated for DL data transfer.
       Max supported Headroom is 128.
 */
...
typedef struct {
  ...
  uint8_t ep_id_valid;  /**< Must be set to true if ep_id is being passed */
  data_ep_id_type_v01 ep_id;
  /**<   \n The peripheral endpoint on which the data format is queried.
...
typedef struct {
  ...
  /**<   Configured packet filtering rule. Values: \n
       ...
       - TRUE  -- Filter is restrictive; rules are treated as a white
                      list (that is, only packets matching a filter rule are
                      permitted and all others are dropped) \n
       - FALSE -- Filter is permissive; rules are treated as a black list
                      (that is, packets matching any filter rule are dropped)
...
typedef struct {
  ...
  /**<   Indicates the onfigured packet filter state. Values:\n
       - TRUE  -- Enabled \n
       - FALSE -- Disabled
  */
  ...
  /**<   Configured packet filtering rule. Values: \n
       - TRUE  -- Filter is restrictive; rules are treated as a white
                      list (only packets matching a filter rule are
                      permitted and all others are dropped) \n
       - FALSE -- Filter is permissive; rules are treated as a black list
                      (packets matching any filter rule are dropped)
...
typedef struct {
  ...
  */
  ...
  uint8_t ep_id_valid;  /**< Must be set to true if ep_id is being passed */
  data_ep_id_type_v01 ep_id;
  /**<   \n The peripheral endpoint on which the QMAP settings are set.
       The default value is the default data channel associated with the
       QMI control channel from which the request is received.
  */
...
typedef struct {
  ...
  uint8_t ep_id_valid;  /**< Must be set to true if ep_id is being passed */
  data_ep_id_type_v01 ep_id;
  /**<   \n The peripheral endpoint on which QMAP settings are queried.
       The default value is the default data channel associated with the
       QMI control channel from which the request is received.
  */
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Request Message; Sets the powersave configuration for the specified endpoint. */
typedef struct {
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Response Message; Sets the powersave configuration for the specified endpoint. */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  Allow Data Flow Control (DFC) Notify  */
  uint8_t allow_dfc_notify_valid;  /**< Must be set to true if allow_dfc_notify is being passed */
  uint8_t allow_dfc_notify;
  /**<   Whether or not Data Flow Control (DFC) notify indications are allowed in powersave mode.
       Only applicable when Powersave Control Flag is
       enabled. Values:\n
       -0: Suppress indications when Powersave Control Flag is enabled \n
       -1: Allow indications when Powersave Control Flag is enabled.
  */

  /* Optional */
  /*  Allow Bearer ID List */
  uint8_t allow_bearer_id_list_valid;  /**< Must be set to true if allow_bearer_id_list is being passed */
  uint32_t allow_bearer_id_list_len;  /**< Must be set to # of elements in allow_bearer_id_list */
  uint8_t allow_bearer_id_list[QMI_DATA_MAX_BEARERS_V01];
  /**<   An allow list of bearer IDs for which the modem should continue to send the
       DFC notify indication. Only applicable when Powersave Control Flag and
       Allow Data Flow Control (DFC) Notify are both enabled.
       Modem replaces the previously configured bearer IDs with the ones in this list.
       In the absence of this TLV and TLV Allow DFC Notify is
       set to TRUE, all bearers on that endpoint are allowed.
  */

  /* Optional */
  /*  Auto Shut Allow Bearer */
  uint8_t auto_shut_allow_bearer_valid;  /**< Must be set to true if auto_shut_allow_bearer is being passed */
  uint8_t auto_shut_allow_bearer;
  /**<   Whether or not to remove a bearer ID from the Allow Bearer ID List
       upon the first DFC notify indication sent during powersave mode.
       Only applicable when Powersave Control Flag is enabled and the
       Allow Bearer ID List is provided. Values:\n
       -0: auto shut off (Default) \n
       -1: Bearer ID will be removed from the allow bearer ID list
           once the first DFC notify indication is sent for the bearer to the control point
  */
...
typedef struct {
  ...
  /*  Peripheral Endpoint ID */
  data_ep_id_type_v01 ep_id;
  /**<   \n The peripheral endpoint on which the capability is negotiated.
       The default value is the default data channel associated with the
       QMI control channel from which the request is received.
  */
 ...
 */
  ...
  /**<   Indicates whether this endpoint is for low latency traffic. Values:\n
       - 0 -- Normal traffic (default) \n
       - 1 -- Low latency traffic
  */

  /* Optional */
  /*  SSC Mode 3 Capability */
  uint8_t ssc_mode3_capability_valid;  /**< Must be set to true if ssc_mode3_capability is being passed */
  uint8_t ssc_mode3_capability;
  /**<   Indicates whether the clients on this endpoint are
       SSC mode 3 capable. Values:\n
       - 0 -- SSC mode 3 is not supported (default) \n
       - 1 -- SSC mode 3 is supported
  */

  /* Optional */
  /*  Low Latency Capability for IMS PDN */
  uint8_t low_latency_capability_for_ims_valid;  /**< Must be set to true if low_latency_capability_for_ims is being passed */
  uint8_t low_latency_capability_for_ims;
  /**<   Indicates whether this endpoint requires IMS traffic to use low latency channel. Values:\n
       - 0 -- IMS traffic will go over normal traffic channel(default) \n
       - 1 -- IMS traffic will go over low latency traffic channel
  */

  /* Optional */
  /*  Multihoming Capability */
  uint8_t ipv6_multihoming_capability_valid;  /**< Must be set to true if ipv6_multihoming_capability is being passed */
  uint8_t ipv6_multihoming_capability;
  /**<   Indicates whether this endpoint requires IPV6 Multihoming support from modem.
       Values:\n
        - 0 -- IPV6 Multihoming is not supported (default) \n
        - 1 -- IPV6 Multihoming is supported
 */

  /* Optional */
  /*  Ethernet PDU Capability */
  uint8_t eth_pdu_capability_valid;  /**< Must be set to true if eth_pdu_capability is being passed */
  uint8_t eth_pdu_capability;
  /**<   Indicates whether this endpoint requires eth PDU support from modem. Values:\n
        - 0  -- ETH PDU is not supported (default) \n
        - 1  -- ETH PDU is supported
 */
 ...
 */
  ...
  uint8_t low_latency_capability_valid;  /**< Must be set to true if low_latency_capability is being passed */
  uint8_t low_latency_capability;
  /**<   Indicates whether low latency traffic is supported on the modem for this endpoint. Values:\n
  ...
  */
  ...
  uint8_t ssc_mode3_capability_valid;  /**< Must be set to true if ssc_mode3_capability is being passed */
  uint8_t ssc_mode3_capability;
  /**<   Indicates whether SSC mode 3 is supported on the modem for this endpoint. Values:\n
       - 0 -- Not supported (default) \n
       - 1 -- Supported
  */
  ...
  */
  ...
  uint8_t ipv6_multihoming_capability_valid;  /**< Must be set to true if ipv6_multihoming_capability is being passed */
  uint8_t ipv6_multihoming_capability;
  /**<   Indicates whether IPV6 multihoming is supported on the modem for this endpoint. Values:\n
     - 0 -- IPV6 Multihoming is not supported (default) \n
     - 1 -- IPV6 Multihoming is supported
 */
  ...
  uint8_t eth_pdu_capability_valid;  /**< Must be set to true if eth_pdu_capability is being passed */
  uint8_t eth_pdu_capability;
  /**<   Indicates whether this endpoint supports Ethernet Pdu. Values:\n
        - 0 -- ETH PDU is not supported (default) \n
        - 1 -- ETH PDU is supported
 */
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Request Message; Negotiates data coalescing configuration between the TE and the modem. */
typedef struct {

  /* Optional */
  /*  Coalescing Eviction Enable */
  uint8_t enable_valid;  /**< Must be set to true if enable is being passed */
  uint8_t enable;
  /**<   Enables Coalescing Eviction
  */

  /* Optional */
  /*  UDP Coalescing Eviction Enable */
  uint8_t udp_enable_valid;  /**< Must be set to true if udp_enable is being passed */
  uint8_t udp_enable;
  /**<   Enables Coalescing Eviction for UDP Connections
  */

  /* Optional */
  /*  TCP Coalescing Eviction Enable  */
  uint8_t tcp_enable_valid;  /**< Must be set to true if tcp_enable is being passed */
  uint8_t tcp_enable;
  /**<   Enables Coalescing Eviction for TCP Connections
  */

  /* Optional */
  /*  UDP Threshold */
  uint8_t udp_threshold_valid;  /**< Must be set to true if udp_threshold is being passed */
  uint32_t udp_threshold;
  /**<   Sets the Coalescing Eviction threshold (in microseconds) for UDP connections.
  */

  /* Optional */
  /*  TCP Threshold */
  uint8_t tcp_threshold_valid;  /**< Must be set to true if tcp_threshold is being passed */
  uint32_t tcp_threshold;
  /**<   Sets the Coalescing Eviction threshold (in microseconds) for TCP connections.
  */

  /* Optional */
  /*  TCP Number */
  uint8_t tcp_num_valid;  /**< Must be set to true if tcp_num is being passed */
  uint8_t tcp_num;
  /**<   Sets the number of HW Contexts used for TCP connections.
  */
}wda_set_data_coalescing_config_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Response Message; Negotiates data coalescing configuration between the TE and the modem. */
typedef struct {
  ...
  uint8_t enable_valid;  /**< Must be set to true if enable is being passed */
  uint8_t enable;
  /**<   Whether Coalescing Eviction is enabled on the modem.
  */
  ...
  uint8_t udp_enable_valid;  /**< Must be set to true if udp_enable is being passed */
  uint8_t udp_enable;
  /**<   Whether Coalescing Eviction for UDP Connections is enabled on the modem.
  */
  ...
  uint8_t tcp_enable_valid;  /**< Must be set to true if tcp_enable is being passed */
  uint8_t tcp_enable;
  /**<   Whether Coalescing Eviction for TCP Connections is enabled on the modem.
  */
  ...
  uint8_t udp_threshold_valid;  /**< Must be set to true if udp_threshold is being passed */
  uint32_t udp_threshold;
  /**<   Coalescing Eviction threshold (in microseconds) for UDP connections.
  */
  ...
  uint8_t tcp_threshold_valid;  /**< Must be set to true if tcp_threshold is being passed */
  uint32_t tcp_threshold;
  /**<   Coalescing Eviction threshold (in microseconds) for TCP connections.
  */
  ...
  uint8_t tcp_num_valid;  /**< Must be set to true if tcp_num is being passed */
  uint8_t tcp_num;
  /**<   Number of HW Contexts used for TCP connections.
  */
}wda_set_data_coalescing_config_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Request Message; Retrieves the data coalescing configuration on the modem. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wda_get_data_coalescing_config_req_msg_v01;
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Response Message; Retrieves the data coalescing configuration on the modem. */
typedef struct {
  ...
  */
  ...
  /**<   Number of HW Contexts used for TCP connections.
  */
}wda_get_data_coalescing_config_resp_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Request Message; Retrieves the Ethernet HW settings. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
}wda_get_eth_config_req_msg_v01;
...
/** @addtogroup wda_qmi_messages
    @{
  */
/** Response Message; Retrieves the Ethernet HW settings. */
typedef struct {
  ...
  /**<   Standard response type. Contains the following data members: \n
     ...
     - qmi_error_type  -- Error code. Possible error code values are described in the error codes section of each message definition */

  /* Optional */
  /*  ETH HW CONFIG */
  uint8_t eth_hw_config_valid;  /**< Must be set to true if eth_hw_config is being passed */
  wda_eth_hw_config_enum_v01 eth_hw_config;
  /**<   Indicates ETH HW settings
      - WDA_ETH_HW_NONE (0x00) --  Ethernet Setting HW Default \n
      - WDA_ETH_HW_VLAN_IP (0x01) --  Ethernet HW VLAN+IP supported \n
      - WDA_ETH_HW_NON_VLAN_IP (0x02) --  Ethernet HW NON_VLAN+IP supported
 */
}wda_get_eth_config_resp_msg_v01;  /* Message */
/**
    @}
  */

/* Conditional compilation tags for message removal */
//#define REMOVE_QMI_WDA_GET_DATA_COALESCING_CONFIG_V01
//#define REMOVE_QMI_WDA_GET_DATA_FORMAT_V01
//#define REMOVE_QMI_WDA_GET_ETH_CONFIG_V01
...
//#define REMOVE_QMI_WDA_SET_DATA_COALESCING_CONFIG_V01
...
#define QMI_WDA_SET_DATA_COALESCING_CONFIG_REQ_V01 0x0031
#define QMI_WDA_SET_DATA_COALESCING_CONFIG_RESP_V01 0x0031
#define QMI_WDA_GET_DATA_COALESCING_CONFIG_REQ_V01 0x0032
#define QMI_WDA_GET_DATA_COALESCING_CONFIG_RESP_V01 0x0032
#define QMI_WDA_GET_ETH_CONFIG_REQ_V01 0x0033
#define QMI_WDA_GET_ETH_CONFIG_RESP_V01 0x0033
/**
    @}
  */
