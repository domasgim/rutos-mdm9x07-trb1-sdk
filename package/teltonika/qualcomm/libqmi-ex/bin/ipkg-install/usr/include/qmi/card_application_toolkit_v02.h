...
/* This file was generated with Tool version 6.14.7
   It was generated on: Wed Jun 12 2019 (Spin 1)
...
#define CAT_V02_IDL_MINOR_VERS 0x25
...
#define QMI_CAT_PDU_SESSION_EST_MAX_LENGTH_V02 255
#define QMI_CAT_DNN_ADDRESS_MAX_LENGTH_V02 102
...
typedef struct {
  ...
  */
  ...
  /**<   Full function event report request bitmask: \n
       ...
       The control point must register the corresponding proactive command with a raw
...
typedef struct {
  ...
  /**<   Geographical location proactive command encoded as in ETSI TS \hyperref[102-223]{102 223}, Section 6.6.40. \n
...
typedef struct {
  ...
  /**<   Response type:
       ...
       the behavior described in Appendix \ref{apx:tableAppResp} applies.
  */
 ...
 */
  ...
  */
  ...
  /**<   Contains the SSID value of the connected WLAN. Coded in the format specified in 3GPP TS \hyperref[31.111]{31.111}.  */
  ...
  /**<   Contains the BSSID value of the connected WLAN. Coded in the format specified in 3GPP TS \hyperref[31.111]{31.111}. */
  ...
  /**<   Contains the HESSID value of the connected WLAN. Coded in the format specified in 3GPP TS \hyperref[31.111]{31.111}. */
...
typedef struct {
  ...
  uint32_t dnn_address_len;  /**< Must be set to # of elements in dnn_address */
  uint8_t dnn_address[QMI_CAT_DNN_ADDRESS_MAX_LENGTH_V02];
  /**<   Data network name. Specified in 3GPP TS \hyperref[24.501]{24.501}. */

  uint32_t pdu_session_est_data_len;  /**< Must be set to # of elements in pdu_session_est_data */
  uint8_t pdu_session_est_data[QMI_CAT_PDU_SESSION_EST_MAX_LENGTH_V02];
  /**<   5GNR PDU session establishment data. Coded as the PDU Session Establishment
       Request message specified in 3GPP TS \hyperref[24.501]{24.501}.
   */
}cat_pdu_session_est_type_v02;  /* Type */
/**
    @}
  */
...
typedef enum {
  ...
  CAT_ACCESS_TECH_NR5G_V02 = 0x00000006,
...
typedef struct {
  ...
  */
  ...
  /**<   Access technology type: \n
       ...
       - 0x00000006 -- CAT_ACCESS_TECH_NR5G -- NR5G is used
  */
 ...
 */
  ...
  uint8_t pdu_session_est_valid;  /**< Must be set to true if pdu_session_est is being passed */
  cat_pdu_session_est_type_v02 pdu_session_est;
