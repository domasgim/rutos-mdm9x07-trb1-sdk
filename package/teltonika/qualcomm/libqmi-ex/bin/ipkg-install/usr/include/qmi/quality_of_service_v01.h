...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Wed Jun 22 2022 (Spin 0)
...
#define QOS_V01_IDL_MINOR_VERS 0x15
 ...
 */
  ...
  */
  ...
  /* Optional */
  /*  Secondary PDU ID */
  uint8_t sec_pdu_id_valid;  /**< Must be set to true if sec_pdu_id is being passed */
  uint32_t sec_pdu_id;
  /**<   PDU ID of the secondary PDU, for example, in the case of SSC Mode 3.
   */
...
typedef struct {
  ...
  /* Optional */
  /*  Secondary PDU QoS Identifier List */
  uint8_t sec_pdu_qos_ids_list_valid;  /**< Must be set to true if sec_pdu_qos_ids_list is being passed */
  uint32_t sec_pdu_qos_ids_list_len;  /**< Must be set to # of elements in sec_pdu_qos_ids_list */
  uint32_t sec_pdu_qos_ids_list[QMI_QOS_MAX_QOS_IDS_V01];
  /**<   QOS IDs of dedicated flows associated with secondary PDU, for example, 
       in the case of SSC Mode 3.
   */
