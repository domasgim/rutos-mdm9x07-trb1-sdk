...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/rel/deploy/data_common/api/data_common_v01.h#8 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9
   It was generated on: Wed Mar 23 2022 (Spin 1)
...
typedef struct {
 ...
 All other values are reserved and ignored.
 */
...
typedef struct {
  ...
  /**<   Specifies if TCP coalescing is enabled or disabled on the modem.
       Values:\n
       - FALSE: Disable TCP coalescing (default).
  ...
  */
  ...
  /**<   Specifies if UDP coalescing is enabled or disabled on the modem.
       Values:\n
       - FALSE: Disable UDP coalescing (default).
...
typedef struct {
  ...
  uint32_t spi;
  /**<   SPI for IPSec, such as, ESP or AH.
   */
